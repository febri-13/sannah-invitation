  ...
  return (
    <div className="min-h-screen bg-cream p-4">
      <header className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-xl font-bold text-leaf-green">Upload Tamu (CSV)</h1>
      </header>
        ...
        {!success ? (
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="mb-4">
              ...
              <button
                ...
                className="w-full py-4 border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center gap-2 text-gray-500 hover:border-islamic-teal hover:text-islamic-teal transition-colors"
              >
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="flex gap-4">
              <button
                onClick={() => router.push("/admin/dashboard")}
                className="flex-1 py-3 bg-islamic-teal text-white rounded-lg font-medium"
              >
                Lihat Dashboard
              </button>
              <button
