  ...
  return (
    <div className="min-h-screen bg-cream p-4">
      <header className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-xl font-bold text-leaf-green">Tambah Tamu</h1>
      </header>
        ...
        {lastCreated && (
          <div className="bg-green-50 border border-green-200 rounded-xl p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="font-medium text-green-800">Tamu terakhir: {lastCreated.namaSiswa}</span>
            </div>
            <div className="bg-white rounded-lg p-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  onClick={copyLink}
                  className="p-2 text-islamic-teal hover:bg-islamic-teal/10 rounded"
                >
            ...
            <button
              ...
              className="mt-3 w-full py-2 bg-green-600 text-white rounded-lg font-medium flex items-center justify-center gap-2"
            >
